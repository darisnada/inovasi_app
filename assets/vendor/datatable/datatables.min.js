! function (t) {
	...
	function i(t) {
		...
		if (n && Et(n), t) {
			...
			!t.sEmptyTable && a && "No data available in table" === e.sEmptyTable && Pt(t, t, "sZeroRecords", "sEmptyTable"), !t.sLoadingRecords && a && "Loading..." === e.sLoadingRecords && Pt(t, t, "sZeroRecords", "sLoadingRecords"), t.sInfoThousands && (t.sThousands = t.sInfoThousands), (t = t.sDecimal) && n !== t && Et(t)
		}
	}
	...
	function d(e, n, r) {
		...
		r !== a && null !== r && (s(r), o(qt.defaults.column, r), r.mDataProp !== a && !r.mData && (r.mData = r.mDataProp), r.sType && (n._sManualType = r.sType), r.className && !r.sClass && (r.sClass = r.className), r.sClass && l.addClass(r.sClass), t.extend(n, r), Pt(n, r, "sWidth", "sWidthOrig"), r.iDataSort !== a && (n.aDataSort = [r.iDataSort]), Pt(n, r, "aDataSort"));
		var c = n.mData,
			f = C(c),
			d = n.mRender ? C(n.mRender) : null;
		r = function (t) {
	...
	function S(t) {
		...
		for (e = 0, n = f.length; e < n; e++)
			if (c = [], !(s = f[e]).sType && s._sManualType) s.sType = s._sManualType;
			else if (!s.sType) {
	...
	function D(e, n, r, o) {
		...
		return e.aiDisplayMaster.push(i), (n = e.rowIdFn(n)) !== a && (e.aIds[n] = l), (r || !e.oFeatures.bDeferRender) && R(e, i, r, o), i
	}
	...
	function C(e) {
		...
		if ("string" == typeof e && (-1 !== e.indexOf(".") || -1 !== e.indexOf("[") || -1 !== e.indexOf("("))) {
			var r = function (e, n, o) {
				var i, l;
				if ("" !== o)
					for (var s = 0, u = (l = w(o)).length; s < u; s++) {
				...
				for (var l, s, u = 0, c = o.length - 1; u < c; u++) {
					if (l = o[u].match(ce), s = o[u].match(fe), l) {
						if (o[u] = o[u].replace(ce, ""), e[o[u]] = [], (i = o.slice()).splice(0, u + 1), l = i.join("."), t.isArray(r))
							for (s = 0, c = r.length; s < c; s++) n(i = {}, r[s], l), e[o[u]].push(i);
						else e[o[u]] = r;
						return
					}
	...
	function N(e) {
		var n, a, r, o, i, l = e.nTHead,
			...
			c = e.oClasses,
			f = e.aoColumns;
		for (u && (o = t("<tr/>").appendTo(l)), n = 0, a = f.length; n < a; n++) i = f[n], r = t(i.nTh).addClass(i.sClass), u && r.appendTo(o), e.oFeatures.bSort && (r.addClass(i.sSortingClass), !1 !== i.bSortable && (r.attr("tabindex", e.iTabIndex).attr("aria-controls", e.sTableId), wt(e, i.nTh, n))), i.sTitle != r[0].innerHTML && r.html(i.sTitle), Ot(e, "header")(e, r, i, c);
		if (u && W(e.aoHeader, l), t(l).find(">tr").attr("role", "row"), t(l).find(">tr>th, >tr>td").addClass(c.sHeaderTH), t(s).find(">tr>th, >tr>td").addClass(c.sFooterTH), null !== s)
			for (n = 0, a = (e = e.aoFooter[0]).length; n < a; n++)(i = f[n]).nTf = e[n].cell, i.sClass && t(i.nTf).addClass(i.sClass)
	}
		...
		for (o = 0, s = h.length; o < s; o++)
			for (r = (a = h[o]).firstChild; r;) {
				if ("TD" == r.nodeName.toUpperCase() || "TH" == r.nodeName.toUpperCase()) {
					for (c = (c = 1 * r.getAttribute("colspan")) && 0 !== c && 1 !== c ? c : 1, f = (f = 1 * r.getAttribute("rowspan")) && 0 !== f && 1 !== f ? f : 1, i = 0, l = e[o]; l[i];) i++;
	...
	function J(e, n) {
		...
		return "data" === r ? n.aaData || n[r] : "" !== r ? C(r)(n) : n
	}
	...
	function Y(t, e, n, a, r, o) {
		...
		r = [];
		if (0 !== qt.ext.search.length && (n = !0), i = Q(t), 0 >= e.length) t.aiDisplay = l.slice();
		else {
	...
	function Q(t) {
		...
		for (e = !1, n = 0, r = t.aoData.length; n < r; n++)
			if (!(s = t.aoData[n])._aFilterData) {
				for (i = [], a = 0, o = u.length; a < o; a++)(e = u[a]).bSearchable ? (l = _(t, n, a, "filter"), c[e.sType] && (l = c[e.sType](l)), null === l && (l = ""), "string" != typeof l && l.toString && (l = l.toString())) : l = "", l.indexOf && -1 !== l.indexOf("&") && (he.innerHTML = l, l = pe ? he.textContent : he.innerText), l.replace && (l = l.replace(/[\r\n]/g, "")), i.push(l);
	...
	function rt(t) {
		...
		if (t.bInitialised) {
			for (M(t), N(t), H(t, t.aoHeader), H(t, t.aoFooter), ft(t, !0), n.bAutoWidth && gt(t), e = 0, n = o.length; e < n; e++)(a = o[e]).sWidth && (a.nTh.style.width = vt(a.sWidth));
			Ht(t, null, "preInit", [t]), O(t), ("ssp" != (o = Mt(t)) || i) && ("ajax" == o ? B(t, [], function (n) {
				var a = J(t, n);
	...
	function it(t, e) {
		var n = parseInt(e, 10);
		t._iDisplayLength = n, kt(t), Ht(t, null, "length", [t, n])
	}
	...
	function ut(t, e, n) {
		var a = t._iDisplayStart,
			r = t._iDisplayLength,
			o = t.fnRecordsDisplay();
		return 0 === o || -1 === r ? a = 0 : "number" == typeof e ? (a = e * r) > o && (a = 0) : "first" == e ? a = 0 : "previous" == e ? 0 > (a = 0 <= r ? a - r : 0) && (a = 0) : "next" == e ? a + r < o && (a += r) : "last" == e ? a = Math.floor((o - 1) / r) * r : Lt(t, 0, "Unknown paging action: " + e, 5), e = t._iDisplayStart !== a, t._iDisplayStart = a, e && (Ht(t, null, "page", [t]), n && k(t)), e
	}
	...
	function ht(e) {
		...
		r = S.scrollHeight > S.clientHeight, e.scrollBarVis !== r && e.scrollBarVis !== a ? (e.scrollBarVis = r, h(e)) : (e.scrollBarVis = r, w.children("thead, tfoot").remove(), I && (o = I.clone().prependTo(w), n = I.find("tr"), o = o.find("tr")), i = T.clone().prependTo(w), T = T.find("tr"), r = i.find("tr"), i.find("th, td").removeAttr("tabindex"), s || (D.width = "100%", d[0].style.width = "100%"), t.each(E(e, i), function (t, n) {
			l = p(e, t), n.style.width = e.aoColumns[l].sWidth
		}), I && pt(function (t) {
			t.style.width = ""
		}, o), d = w.outerWidth(), "" === s ? (x.width = "100%", F && (w.find("tbody").height() > S.offsetHeight || "scroll" == v.css("overflow-y")) && (x.width = vt(w.outerWidth() - f)), d = w.outerWidth()) : "" !== u && (x.width = vt(u), d = w.outerWidth()), pt(H, r), pt(function (e) {
			j.push(e.innerHTML), P.push(vt(t(e).css("width")))
		}, r), pt(function (e, n) {
			-1 !== t.inArray(e, L) && (e.style.width = P[n])
		}, T), t(r).height(0), I && (pt(H, o), pt(function (e) {
			N.push(e.innerHTML), R.push(vt(t(e).css("width")))
		}, o), pt(function (t, e) {
			t.style.width = R[e]
	...
	function gt(n) {
		...
		if (y || !v && !s && !l && c == b(n) && c == d.length)
			for (a = 0; a < c; a++) null !== (f = p(n, a)) && (i[f].sWidth = vt(d.eq(a).width()));
		else {
			...
			if (n.aoData.length)
				for (a = 0; a < f.length; a++) r = i[v = f[a]], t(mt(n, v)).clone(!1).append(r.sContentPadding).appendTo(_);
			for (t("[name]", c).removeAttr("name"), r = t("<div/>").css(s || l ? {
					...
					right: 0,
					overflow: "hidden"
				} : {}).append(c).appendTo(S), s && u ? c.width(u) : s ? (c.css("width", "auto"), c.removeAttr("width"), c.width() < S.clientWidth && g && c.width(S.clientWidth)) : l ? c.width(S.clientWidth) : g && c.width(g), a = l = 0; a < f.length; a++) u = (S = t(d[a])).outerWidth() - S.width(), l += S = D.bBounding ? Math.ceil(d[a].getBoundingClientRect().width) : S.outerWidth(), i[f[a]].sWidth = vt(S - u);
	...
	function St(t, e) {
		for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)(n = (n = (n = _(t, o, e, "display") + "").replace(ge, "")).replace(/&nbsp;/g, " ")).length > a && (a = n.length, r = o);
		return r
	}
	...
	function Dt(e) {
		...
		for (o = function (e) {
			...
			for (n = 0, r = (o = c[s = f[e][0]].aDataSort).length; n < r; n++) l = c[i = o[n]].sType || "string", f[e]._idx === a && (f[e]._idx = t.inArray(f[e][1], c[i].asSorting)), u.push({
				src: s,
				col: i,
				dir: f[e][1],
				index: f[e]._idx,
		...
		if ("ssp" != Mt(t) && 0 !== r.length) {
			...
			s === r.length ? u.sort(function (t, e) {
				var n, a, i, s, u = r.length,
					...
					f = l[e]._aSortData;
				for (i = 0; i < u; i++)
					if (0 !== (n = (n = c[(s = r[i]).col]) < (a = f[s.col]) ? -1 : n > a ? 1 : 0)) return "asc" === s.dir ? n : -n;
				...
				var n, a, s, u, c = r.length,
					...
					d = l[e]._aSortData;
				for (s = 0; s < c; s++)
					if (n = f[(u = r[s]).col], a = d[u.col], 0 !== (n = (u = i[u.type + "-" + u.dir] || i["string-" + u.dir])(n, a))) return n;
				return (n = o[t]) < (a = o[e]) ? -1 : n > a ? 1 : 0
			})
		}
		t.bSorted = !0
	...
	function xt(t, e) {
		...
		for (var o, i = qt.ext.type.order[a.sType + "-pre"], l = 0, s = t.aoData.length; l < s; l++)(a = t.aoData[l])._aSortData || (a._aSortData = []), (!a._aSortData[e] || r) && (o = r ? n[l] : _(t, l, e, "sort"), a._aSortData[e] = i ? i(o) : o)
	}
	...
	function It(e) {
		if (e.oFeatures.bStateSave && !e.bDestroying) {
			var n = {
				...
				search: K(e.oPreviousSearch),
				columns: t.map(e.aoColumns, function (t, n) {
					return {
						visible: t.bVisible,
						search: K(e.aoPreSearchCols[n])
					}
				})
			};
			...
			if (n && n.time) {
				...
				if (-1 === t.inArray(!1, s) && !(0 < (s = e.iStateDuration) && n.time < +new Date - 1e3 * s || n.columns && l.length !== n.columns.length)) {
					if (e.oLoadedState = t.extend(!0, {}, n), n.start !== a && (e._iDisplayStart = n.start, e.iInitDisplayStart = n.start), n.length !== a && (e._iDisplayLength = n.length), n.order !== a && (e.aaSorting = [], t.each(n.order, function (t, n) {
						...
						for (o = 0, i = n.columns.length; o < i; o++)(s = n.columns[o]).visible !== a && (l[o].bVisible = s.visible), s.search !== a && t.extend(e.aoPreSearchCols[o], tt(s.search));
	...
	var Ut, Vt, Xt, Jt, qt = function (e) {
			...
			return this.each(function () {
				...
				if ("table" != this.nodeName.toLowerCase()) Lt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
					...
					]), Pt(I.oLanguage, g, "fnInfoCallback"), Nt(I, "aoDrawCallback", g.fnDrawCallback, "user"), Nt(I, "aoServerParams", g.fnServerParams, "user"), Nt(I, "aoStateSaveParams", g.fnStateSaveParams, "user"), Nt(I, "aoStateLoadParams", g.fnStateLoadParams, "user"), Nt(I, "aoStateLoaded", g.fnStateLoaded, "user"), Nt(I, "aoRowCallback", g.fnRowCallback, "user"), Nt(I, "aoRowCreatedCallback", g.fnCreatedRow, "user"), Nt(I, "aoHeaderCallback", g.fnHeaderCallback, "user"), Nt(I, "aoFooterCallback", g.fnFooterCallback, "user"), Nt(I, "aoInitComplete", g.fnInitComplete, "user"), Nt(I, "aoPreDrawCallback", g.fnPreDrawCallback, "user"), I.rowIdFn = C(g.rowId), u(I);
					var A = I.oClasses;
					...
					t.extend(!0, F, g.oLanguage), F.sUrl && (t.ajax({
						...
						url: F.sUrl,
						success: function (e) {
							i(e), o(S.oLanguage, e), t.extend(!0, F, e), rt(I)
						},
						error: function () {
							rt(I)
						}
					}), m = !0), null === g.asStripeClasses && (I.asStripeClasses = [A.sStripeOdd, A.sStripeEven]);
					p = I.asStripeClasses;
					...
					p = function () {
						...
						Ct(I), R.bSort && Nt(I, "aoDrawCallback", function () {
							if (I.bSorted) {
								var e = Dt(I),
									n = {};
							...
							(I.bSorted || "ssp" === Mt(I) || R.bDeferRender) && Ct(I)
						}, "sc");
					...
					g.bStateSave ? (R.bStateSave = !0, Nt(I, "aoDrawCallback", It, "state_save"), At(I, g, p)) : p()
				}
			}), n = null, this
		},
		Gt = {},
	...
	Vt = function (e, n) {
		...
		var a = [],
			r = function (e) {
				(e = function (e) {
					...
					return e ? e.nTable && e.oApi ? [e] : e.nodeName && "table" === e.nodeName.toLowerCase() ? -1 !== (n = t.inArray(e, o)) ? [r[n]] : null : e && "function" == typeof e.settings ? e.settings().toArray() : ("string" == typeof e ? a = t(e) : e instanceof t && (a = e), a ? a.map(function () {
		...
		iterator: function (t, e, n, r) {
			...
			for ("string" == typeof t && (r = n, n = e, e = t, t = !1), i = 0, l = h.length; i < l; i++) {
				...
				if ("table" === e)(o = n.call(g, h[i], i)) !== a && d.push(o);
					...
					for (f = this[i], "column-rows" === e && (c = Te(h[i], p.opts)), s = 0, u = f.length; s < u; s++) o = f[s], (o = "cell" === e ? n.call(g, h[i], o.row, o.column, i, s) : n.call(g, h[i], o, i, s, c)) !== a && d.push(o)
			}
		...
		if (a.length && n && (n instanceof Vt || n.__dt_wrapper)) {
			...
			for (r = 0, o = a.length; r < o; r++) n[(i = a[r]).name] = "function" == typeof i.val ? l(e, i.val, i) : t.isPlainObject(i.val) ? {} : i.val, n[i.name].__dt_wrapper = !0, Vt.extend(e, n[i.name], i.propExt)
		}
	...
	var De = function (e, n, r, o, i) {
		...
		Te = function (e, n) {
			...
			if ("current" == r)
				...
				for (a = 0, r = e.aoData.length; a < r; a++) "none" == s ? i.push(a) : (-1 === (o = t.inArray(a, l)) && "removed" == s || 0 <= o && "applied" == s) && i.push(a);
			return i
		};
	Xt("rows()", function (e, n) {
		...
		return this.iterator("row", function (e, n, r) {
			...
			for (c.splice(n, 1), o = 0, i = c.length; o < i; o++)
				if (u = (l = c[o]).anCells, null !== l.nTr && (l.nTr._DT_RowIndex = o), null !== u)
			...
			if (n.length && t.length) {
				...
				if (a._details) {
					...
					o.off("draw.dt.DT_details column-visibility.dt.DT_details destroy.dt.DT_details"), 0 < re(i, "_details").length && (o.on("draw.dt.DT_details", function (t, e) {
						...
						if (r === e)
							for (var n, a = b(e), o = 0, l = i.length; o < l; o++)(n = i[o])._details && n._details.children("td[colspan]").attr("colspan", a)
	...
	Xt("columns()", function (e, n) {
		...
		if (t.isPlainObject(e) && (e.row === a ? (r = e, e = null) : (r = n, n = null)), t.isPlainObject(n) && (r = n, n = null), null === n || n === a) return this.iterator("table", function (n) {
			var o, i, l, s, u, c, f, d = e,
				...
				b = le(oe(p, g, "anCells")),
				m = t([].concat.apply([], b)),
				S = n.aoColumns.length;
			return De("cell", d, function (e) {
				var r = "function" == typeof e;
				if (null === e || e === a || r) {
					for (i = [], l = 0, s = g.length; l < s; l++)
						for (o = g[l], u = 0; u < S; u++) c = {
							row: o,
							column: u
						}, r ? (f = p[o], e(c, _(n, o, u), f.anCells ? f.anCells[u] : null) && i.push(c)) : i.push(c);
					return i
				}
				return t.isPlainObject(e) ? e.column !== a && e.row !== a && -1 !== t.inArray(e.row, g) ? [e] : [] : (r = m.filter(e).map(function (t, e) {
					return {
		...
		for (var e, n, a = qt.version.split("."), r = 0, o = (t = t.split(".")).length; r < o; r++)
			if ((e = parseInt(a[r], 10) || 0) !== (n = parseInt(t[r], 10) || 0)) return e > n;
		return !0
		...
		return (e = C(e)(o.oLanguage)) === a && (e = n), r !== a && t.isPlainObject(e) && (e = e[r] !== a ? e[r] : e._), e.replace("%d", r)
		...
		pageButton: {
			_: function (e, r, o, i, l, s) {
				var u, c, f, d = e.oClasses,
					...
					g = 0,
					b = function (n, a) {
						var r, i, f, m, S = function (t) {
							ut(e, t.data.action, !0)
						};
						for (r = 0, i = a.length; r < i; r++)
							if (m = a[r], t.isArray(m)) f = t("<" + (m.DT_el || "div") + "/>").appendTo(n), b(f, m);
							else {
								switch (u = null, c = "", m) {
									case "ellipsis":
										...
										break;
									case "first":
										u = h.sFirst, c = m + (l > 0 ? "" : " " + d.sPageButtonDisabled);
										break;
									case "previous":
										u = h.sPrevious, c = m + (l > 0 ? "" : " " + d.sPageButtonDisabled);
										break;
									case "next":
										u = h.sNext, c = m + (l < s - 1 ? "" : " " + d.sPageButtonDisabled);
										break;
									case "last":
										u = h.sLast, c = m + (l < s - 1 ? "" : " " + d.sPageButtonDisabled);
										break;
									default:
										u = m + 1, c = l === m ? d.sPageButtonActive : ""
								}
								null !== u && (jt(f = t("<a>", {
...
function (t) {
	...
	return t.extend(!0, r.defaults, {
					...
					if (d = a[r], t.isArray(d)) S(n, d);
						...
						switch (f = c = "", d) {
							case "ellipsis":
								...
								break;
							case "first":
								c = g.sFirst, f = d + (0 < s ? "" : " disabled");
								break;
							case "previous":
								c = g.sPrevious, f = d + (0 < s ? "" : " disabled");
								break;
							case "next":
		...
		S(t(o).empty().html('<ul class="pagination"/>').children("ul"), l), d !== a && t(o).find("[data-dt-idx=" + d + "]").focus()
	}, r
});
